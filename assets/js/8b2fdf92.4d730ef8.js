/*! For license information please see 8b2fdf92.4d730ef8.js.LICENSE.txt */
...
`];var D=o(8536),S=function(e,t,o,i){var n,r=arguments.length,s=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,o,i);else for(var l=e.length-1;l>=0;l--)(n=e[l])&&(s=(r<3?n(s):r>3?n(t,o,s):n(t,o))||s);return r>3&&s&&Object.defineProperty(t,o,s),s};class T extends d.oi{constructor(){super(),this.options=[],this.open=!1,this.placeholder="",this.search="",this.trigger="click",this.positioningStyle="",this.boundery={right:!1},this.showChildrenMap=new Map,this.selectedElementMap=new Map,this.hasSlotLabel=!1,this.dropdownContentRef=w(),this.dropdownInitiatorRef=w(),this.onItemMouseOver=(e,t)=>{var o;t.value&&(t.value.style.marginTop=(null===(o=e.value)||void 0===o?void 0:o.offsetTop)+"px")},this.addEventListener("contextmenu",this.handleRightClick)}handleRightClick(e){"context-menu"==this.trigger&&(e.preventDefault(),this.open=!0,setTimeout((()=>{const t=this.shadowRoot.querySelector(".dropdown-content");console.log(e),t.style.left=`${e.clientX}px`,t.style.top=`${e.clientY}px`,t.style.position="fixed",this.requestUpdate()})))}firstUpdated(){this.hasSlotLabel=!!this._prefixItems.length,this.performUpdate()}render(){return d.dy`
      <div class="dropdown">
        ${this.renderDropDownIntiator()} ${this.open&&this.renderDropdowContent()||d.Ld}
      </div>
    `}getRandomId(){return`id-${Math.random().toString(36).substr(2,9)}`}renderDropDownIntiator(){return d.dy`
    ...
    `}renderOption(e){var t;const o=w(),i=w(),n=this.showChildrenMap.get(e)||!1,r=this.getRandomId();return d.dy`
      ${"divider"===e.type?d.dy`<li class="divider"></li>`:d.dy`
            <li
              id="${r}"
              ${C(i)}
              @click="${t=>{e.template?t&&t.stopPropagation():this.handleSelect(e,t)}}"
              class=${(0,D.$)({selected:Boolean(e===this.selected||this.selectedElementMap.get(e)),"group-element":"group"===e.type})}
              @mouseover="${()=>{this.showChildrenMap.set(e,!0),this.requestUpdate()}}"
              @mouseleave="${()=>{this.showChildrenMap.set(e,!1),this.requestUpdate()}}"
            >
              <span class=${(0,D.$)({"group-label":"group"===e.type})}
                >${d.dy`${e.template?e.template(e):e.label}`}
                ${(null===(t=this.searchedELement)||void 0===t?void 0:t.label)===e.label?d.dy`<span class="arrow arrow-ccontainer">
                      <hy-icon name="arrow-left"></hy-icon>
                    </span>`:""}
              </span>
              ${e.children?d.dy`
                    ${"group"!=e.type?d.dy`<hy-icon
                          style="z-index:0"
                          name="caret-right"
                    ...
                    <ul
                      ${C(o)}
                      class="  ${(0,D.$)({"nested-search":n,nested:"group"!=e.type,"nested-group":"group"===e.type})}"
          ...
          `}
    `}calculateOffsetTop(e){return requestAnimationFrame((()=>{const t=this.shadowRoot.getElementById(`${e}`),o=null==t?void 0:t.querySelector("ul.nested");o&&(o.style.marginTop=`${null==t?void 0:t.offsetTop}px`),this.positionDropDown()})),this.requestUpdate(),0}updated(e){super.updated(e),e.has("search")&&this.search&&(this.searching(),this.open||(this.open=!0))}searching(){this.options;const e=[];this.recursivesearch(e,this.options,this.search),this.showChildrenMap=new Map,this.selectedElementMap=new Map,this.searchedELement=void 0;for(const t of e)this.showChildrenMap.set(t,!0),this.selectedElementMap.set(t,!0),this.searchedELement=t}recursivesearch(e,t,o){for(const i of t){if(i.label.toLowerCase().includes(o))return void e.push(i);if(i.children){if(e.push(i),this.recursivesearch(e,i.children,o),!e.length||e[e.length-1]!==i)return;e.pop()}}}handleSelect(e,t){t&&t.stopPropagation(),this.selected=e,this.open=!1;const o=new CustomEvent("change",{detail:{value:this.selected},bubbles:!0,composed:!0});this.dispatchEvent(o)}toggleDropdown(){this.open=!this.open}showDropdown(){this.open=!0}positionDropDown(){this.getDistanceFromBRight(this.dropdownContentRef.value);this.getDistanceFromBRight(this.dropdownContentRef.value)<this.dropdownContentRef.value.offsetWidth&&(this.dropdownContentRef.value.style.marginLeft="-"+(this.dropdownContentRef.value.offsetWidth-this.dropdownInitiatorRef.value.offsetWidth)+"px",this.positioningStyle=`margin-left : -${2*this.dropdownContentRef.value.offsetWidth}px`,this.boundery.right=!0)}_onClickOutside(e){e.composedPath().includes(this)||(this.open=!1)}getDistanceFromBottom(e){const t=e.getBoundingClientRect();return Math.max(0,window.innerHeight-t.bottom)}getDistanceFromBRight(e){const t=e.getBoundingClientRect();return Math.max(0,window.innerWidth-t.right)}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._onClickOutside.bind(this))}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._onClickOutside.bind(this))}}T.styles=$,S([(0,a.Cb)({type:Array})],T.prototype,"options",void 0),S([(0,a.Cb)({type:Object})],T.prototype,"selected",void 0),S([(0,a.Cb)({type:Boolean})],T.prototype,"open",void 0),S([(0,a.Cb)({type:String})],T.prototype,"placeholder",void 0),S([(0,a.Cb)({type:String})],T.prototype,"search",void 0),S([(0,a.Cb)({type:String})],T.prototype,"trigger",void 0),S([(0,a.SB)()],T.prototype,"positioningStyle",void 0),S([(0,a.SB)()],T.prototype,"boundery",void 0),S([(0,a.SB)()],T.prototype,"searchedELement",void 0),S([(0,a.SB)()],T.prototype,"showChildrenMap",void 0),S([(0,a.NH)({slot:"label",flatten:!0})],T.prototype,"_prefixItems",void 0),S([(0,a.SB)()],T.prototype,"hasSlotLabel",void 0),customElements.define("hy-dropdown",T);o(780);var O=o(8688),_=(o(3430),o(3992));const B=(0,o(1943).L)({tagName:"hy-dropdown",elementClass:T,react:s,events:{}}),M=["components"],R={sidebar_position:5},A="Dropdown",H={unversionedId:"components/dropdown",id:"components/dropdown",title:"Dropdown",description:"When To Use",source:"@site/docs/components/dropdown.mdx",sourceDirName:"components",slug:"/components/dropdown",permalink:"/docs/docs/components/dropdown",draft:!1,editUrl:"https://github.com/hybridui/docs/tree/main/docs/components/dropdown.mdx",tags:[],version:"current",sidebarPosition:5,frontMatter:{sidebar_position:5},sidebar:"tutorialSidebar",previous:{title:"Calendar",permalink:"/docs/docs/components/calendar"},next:{title:"Icons",permalink:"/docs/docs/components/icons"}},I={},E=[{value:"When To Use",id:"when-to-use",level:3},{value:"Basic",id:"basic",level:3},{value:"Divider",id:"divider",level:3},{value:"Multi-level",id:"multi-level",level:3},{value:"Triggers",id:"triggers",level:3},{value:"Search mode (MacOS like)",id:"search-mode-macos-like",level:3},{value:"Context Menu",id:"context-menu",level:3},{value:"Group",id:"group",level:3},{value:"Custom template",id:"custom-template",level:3}],L=e=>{let{children:t,color:o}=e;return(0,l.kt)(r.Fragment,null,(0,l.kt)(B,{placeholder:"Select an option",options:[{label:"Option 1"},{label:"Option 2"},{label:"Option 3"}],trigger:"hover",mdxType:"HyDropdown"},(0,l.kt)(_.R,{slot:"label",type:"link",icon:"angle-down",mdxType:"HyButton"},"Hover me")))},j=e=>{let{children:t,color:o}=e;return(0,l.kt)(r.Fragment,null,(0,l.kt)(B,{placeholder:"Select an option",options:[{label:"Option 1",children:[{label:"Sub-option 1"},{label:"Sub-option 2",children:[{label:"Sub-sub-option 10"}]}]},{label:"Option 2"},{label:"Option 3",children:[{label:"Sub-option 3"}]}],trigger:"hover",mdxType:"HyDropdown"},(0,l.kt)(_.R,{slot:"label",type:"link",icon:"angle-down",mdxType:"HyButton"},"Hover me")))},N=e=>{let{children:t,color:o}=e;return(0,l.kt)(r.Fragment,null,(0,l.kt)(B,{placeholder:"Select an option",options:[{label:"Option 1",children:[{label:"Sub-option 1"},{label:"Sub-option 2",children:[{label:"Sub-sub-option 10"}]}]},{label:"Option 2"},{label:"Option 3",children:[{label:"Sub-option 3"}]}],mdxType:"HyDropdown"},(0,l.kt)(_.R,{slot:"label",mdxType:"HyButton"},"Click me")))},z=e=>{let{children:t,color:o}=e;const[i,n]=(0,r.useState)(),s=[{label:"New",children:[{label:"Folder"},{label:"File",children:[{label:"From disk"},{label:"From Onedrine"}]}]},{label:"Open",children:[{label:"Recent",children:[...[1,2,3,4,5,6,7].map((e=>({label:"App "+e})))]}]},{label:"Close project"}];return(0,l.kt)(r.Fragment,null,(0,l.kt)(B,{search:i,placeholder:"Select an option",options:s,mdxType:"HyDropdown"},i,(0,l.kt)(O.s,{placeholder:"Type to search",slot:"label",icon:"ellipsis-v",valueChange:function(e){n(e.detail.value)},mdxType:"HyInput"},(0,l.kt)("span",{slot:"suffix"},(0,l.kt)("hy-icon",{name:"times-circle",click:function(){n("")}})," "))))},U=e=>{let{children:t,color:o}=e;return(0,l.kt)(r.Fragment,null,(0,l.kt)(B,{placeholder:"Select an option",options:[{label:"Save"},{label:"Print"},{label:"Delete"}],trigger:"context-menu",mdxType:"HyDropdown"},(0,l.kt)("div",{slot:"label",style:{color:"white",background:"gray",height:"200px",width:"400px",textAlign:"center",lineHeight:"200px"}},"Right Click on here")))},Y=e=>{let{children:t,color:o}=e;return(0,l.kt)(r.Fragment,null,(0,l.kt)(B,{placeholder:"Select an option",options:[{label:"Option 1"},{type:"divider"},{label:"Option 2"},{label:"Option 3"},{label:"Option 4"},{type:"divider"},{label:"Option 5"}],trigger:"hover",mdxType:"HyDropdown"},(0,l.kt)(_.R,{slot:"label",type:"link",icon:"angle-down",mdxType:"HyButton"},"Hover me")))},F=e=>{let{children:t,color:o}=e;return(0,l.kt)(r.Fragment,null,(0,l.kt)(B,{placeholder:"Select an option",options:[{label:"Option 1",type:"group",children:[{label:"Sub-option 1"},{label:"Sub-option 2"}]},{type:"divider"},{label:"Option 2"},{label:"Option 3",children:[{label:"Sub-option 3"}]}],trigger:"hover",mdxType:"HyDropdown"},(0,l.kt)(_.R,{slot:"label",type:"link",icon:"angle-down",mdxType:"HyButton"},"Hover me")))},P=e=>{let{children:t,color:o}=e;return(0,l.kt)(r.Fragment,null,(0,l.kt)(B,{placeholder:"Select an option",options:[{label:"Option 1",type:"group",children:[{label:"Sub-option 1"},{label:"Sub-option 2",children:[{label:"Sub-sub-option 10"}]}]},{type:"divider"},{label:"Option 2"},{label:"Option 3",children:[{label:"Sub-option 3"}]}],trigger:"hover",mdxType:"HyDropdown"},(0,l.kt)(_.R,{slot:"label",type:"link",icon:"angle-down",mdxType:"HyButton"},"Hover me")))},X=e=>{let{children:t,color:o}=e;const i=e=>{e.preventDefault(),alert("clicked")},n=[{label:"Option 1",template:function(e){return d.dy`<div style="display: flex"><hy-input style="width: 80%; text: red !important" value="${e.label} "> </hy-input><hy-button style="width: 19%" @click=${i} > ok</hy-button></span> </div>`}},{label:"Option 2"},{label:"Option 3"}];return(0,l.kt)(r.Fragment,null,(0,l.kt)(B,{placeholder:"Select an option",options:n,trigger:"hover",mdxType:"HyDropdown"},(0,l.kt)(_.R,{slot:"label",type:"link",icon:"angle-down",mdxType:"HyButton"},"Hover me")))},W={toc:E,BasicDropdowHover:L,BasicDropdowHoverCascading:j,BasicDropdowClick:N,SearchInDropdown:z,ContextDropdown:U,BasicDropdowDiverder:Y,BasicDropdowGroup:F,BasicDropdowGroupMixed:P,BasicDropdowCustomTemplate:X},q="wrapper";function G(e){let{components:t}=e,o=(0,n.Z)(e,M);return(0,l.kt)(q,(0,i.Z)({},W,o,{components:t,mdxType:"MDXLayout"}),(0,l.kt)("h1",{id:"dropdown"},"Dropdown"),(0,l.kt)("h3",{id:"when-to-use"},"When To Use"),(0,l.kt)("p",null,"When faced with multiple choices, you have the option to enclose them within a Dropdown. By either hovering over or clicking on the trigger, a menu will appear, presenting a list of options for you to select from and carry out the corresponding action."),(0,l.kt)("h3",{id:"basic"},"Basic"),(0,l.kt)("p",null,"The simplest form of a dropdown menu."),(0,l.kt)(L,{mdxType:"BasicDropdowHover"}),(0,l.kt)("br",null),(0,l.kt)("h3",{id:"divider"},"Divider"),(0,l.kt)("p",null,"Add devider between option."),(0,l.kt)(Y,{mdxType:"BasicDropdowDiverder"}),(0,l.kt)("br",null),(0,l.kt)("h3",{id:"multi-level"},"Multi-level"),(0,l.kt)("p",null,"Cascading dropdown menu."),(0,l.kt)(j,{mdxType:"BasicDropdowHoverCascading"}),(0,l.kt)("h3",{id:"triggers"},"Triggers"),(0,l.kt)("p",null,"The default trigger mode is ",(0,l.kt)("inlineCode",{parentName:"p"},"hover"),", it can be changed to ",(0,l.kt)("inlineCode",{parentName:"p"},"click"),"."),(0,l.kt)(N,{mdxType:"BasicDropdowClick"}," "),(0,l.kt)("h3",{id:"search-mode-macos-like"},"Search mode (MacOS like)"),(0,l.kt)("p",null,"This feature can be beneficial when utilizing a dropdown menu with an excessive number of options."),(0,l.kt)(z,{mdxType:"SearchInDropdown"}," "),(0,l.kt)("h3",{id:"context-menu"},"Context Menu"),(0,l.kt)(U,{mdxType:"ContextDropdown"}),(0,l.kt)("h3",{id:"group"},"Group"),(0,l.kt)("p",null,"You have the ability to organize the options by placing them within a group."),(0,l.kt)(F,{mdxType:"BasicDropdowGroup"}),(0,l.kt)("br",null),(0,l.kt)("br",null),(0,l.kt)("p",null,"You have the option to group items and maintain a menu style for nested options."),(0,l.kt)(P,{mdxType:"BasicDropdowGroupMixed"}),(0,l.kt)("br",null),(0,l.kt)("h3",{id:"custom-template"},"Custom template"),(0,l.kt)("p",null,"You have the flexibility to utilize a custom template for each option or specify a template for individual options.\nThe template employs the lit-html package, making it compatible with any framework or library for its usage."),(0,l.kt)(X,{mdxType:"BasicDropdowCustomTemplate"}," "))}G.isMDXComponent=!0},875:(e,t,o)=>{o.d(t,{XM:()=>n,Xe:()=>r,pX:()=>i});const i={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},n=e=>(...t)=>({_$litDirective$:e,values:t});class r{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,o){this._$Ct=e,this._$AM=t,this._$Ci=o}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}},8536:(e,t,o)=>{o.d(t,{$:()=>r});var i=o(3692),n=o(875);const r=(0,n.XM)(class extends n.Xe{constructor(e){var t;if(super(e),e.type!==n.pX.ATTRIBUTE||"class"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter((t=>e[t])).join(" ")+" "}update(e,[t]){var o,n;if(void 0===this.nt){this.nt=new Set,void 0!==e.strings&&(this.st=new Set(e.strings.join(" ").split(/\s/).filter((e=>""!==e))));for(const e in t)t[e]&&!(null===(o=this.st)||void 0===o?void 0:o.has(e))&&this.nt.add(e);return this.render(t)}const r=e.element.classList;this.nt.forEach((e=>{e in t||(r.remove(e),this.nt.delete(e))}));for(const i in t){const e=!!t[i];e===this.nt.has(i)||(null===(n=this.st)||void 0===n?void 0:n.has(i))||(e?(r.add(i),this.nt.add(i)):(r.remove(i),this.nt.delete(i)))}return i.Jb}})}}]);