/*! For license information please see 9ffc012b.ae95d4a2.js.LICENSE.txt */
...
`,r.iv``];var l=n(3692),i=n(875);const s=(0,i.XM)(class extends i.Xe{constructor(t){var e;if(super(t),t.type!==i.pX.ATTRIBUTE||"class"!==t.name||(null===(e=t.strings)||void 0===e?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter((e=>t[e])).join(" ")+" "}update(t,[e]){var n,r;if(void 0===this.nt){this.nt=new Set,void 0!==t.strings&&(this.st=new Set(t.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in e)e[t]&&!(null===(n=this.st)||void 0===n?void 0:n.has(t))&&this.nt.add(t);return this.render(e)}const o=t.element.classList;this.nt.forEach((t=>{t in e||(o.remove(t),this.nt.delete(t))}));for(const a in e){const t=!!e[a];t===this.nt.has(a)||(null===(r=this.st)||void 0===r?void 0:r.has(a))||(t?(o.add(a),this.nt.add(a)):(o.remove(a),this.nt.delete(a)))}return l.Jb}});var p,d=function(t,e,n,r){var o,a=arguments.length,l=a<3?e:null===r?r=Object.getOwnPropertyDescriptor(e,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)l=Reflect.decorate(t,e,n,r);else for(var i=t.length-1;i>=0;i--)(o=t[i])&&(l=(a<3?o(l):a>3?o(e,n,l):o(e,n))||l);return a>3&&l&&Object.defineProperty(e,n,l),l};!function(t){t.EMAIL="email",t.PASSWORD="password",t.TEL="tel",t.TEXT="text",t.URL="url"}(p||(p={}));let u=class extends r.oi{constructor(){super(...arguments),this.disabled=!1,this.value="",this.type=p.TEXT,this.spanClasses={inputfocuced:!1},this.slottedClasses={prefixed:!1,suffixed:!1}}firstUpdated(){for(const t of this._postItems)t.setAttribute("usedas","post");for(const t of this._preItems)t.setAttribute("usedas","pre");this.slottedClasses=Object.assign(Object.assign({},this.slottedClasses),{prefixed:!!this._prefixItems.length,post:!!this._postItems.length,pre:!!this._preItems.length}),this.performUpdate()}focusHandler(t){this.spanClasses=Object.assign(Object.assign({},this.spanClasses),{inputfocuced:!0})}blurHandler(t){this.spanClasses=Object.assign(Object.assign({},this.spanClasses),{inputfocuced:!1})}updated(t){super.updated(t),t.has("value")&&this.requestUpdate()}render(){var t,e;return r.dy`
      <slot name="pre"></slot>
      <span
        class="${s(Object.assign(Object.assign({},this.spanClasses),this.slottedClasses))}"
